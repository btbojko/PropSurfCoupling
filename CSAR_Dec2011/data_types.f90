...
!
    INTEGER :: myid,dnbr(4),comm3d,send_void(4),recv_void(4)
...
!
    ...
    REAL(KIND=double), DIMENSION(:,:,:), POINTER :: f           ! pointer to vector F for the mesh
    REAL(KIND=double), DIMENSION(:,:,:), POINTER :: x           ! pointer to vector X for the mesh
    ...
    REAL(KIND=double), DIMENSION(:,:,:), POINTER :: c9
